...
import com.example.luynthibnglixeb1.model.Question;
...
public class Database extends SQLiteOpenHelper {
   ...
   //vertion
    ...
    private void CreatCategories(){
        //B2 id=1
        Category c1 = new Category("B2");
        insertCategories(c1);
        //B1 id=2
        Category c2 = new Category("B1");
        insertCategories(c2);
        //c id=3
        Category c3 = new Category("C");
        insertCategories(c3);
    }
    //insert cau hoi va dap an vao csdl
   ...
   if (c.moveToFirst()){
       do{
        ...
        /*   question.setId(c.getInt(c.getColumnIndex(Table.QuestionsTable._ID)));
           ...
           question.setOption1(c.getInt(c.getColumnIndex(Table.QuestionsTable.COLUMN_OPTION1)));
           question.setOption2(c.getInt(c.getColumnIndex(Table.QuestionsTable.COLUMN_OPTION2)));
           question.setOption3(c.getInt(c.getColumnIndex(Table.QuestionsTable.COLUMN_OPTION3)));
